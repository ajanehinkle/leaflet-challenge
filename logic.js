...
function chooseColor(depth) {
    ...
    else if (depth > 10 & depth <= 25) return "purple";
    else if (depth > 25 & depth <= 40) return "blue";
    else if (depth > 40 & depth <= 55) return "green";
    else if (depth > 55 & depth <= 70) return "magenta";
    else return "black";
};
...
legend.onAdd = function(myMap) {
    var div = L.DomUtil.create("div", "legend");
       ...
       div.innerHTML += '<i style="background: purple"></i><span>(10 < Depth <= 25)</span><br>';
       div.innerHTML += '<i style="background: blue"></i><span>(25 < Depth <= 40)</span><br>';
       div.innerHTML += '<i style="background: green"></i><span>(40 < Depth <= 55)</span><br>';
       div.innerHTML += '<i style="background: magenta"></i><span>(55 < Depth <= 70)</span><br>';
